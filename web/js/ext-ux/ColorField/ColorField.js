 ...
 * <br />Example:
 * <pre><code>
var cf = new Ext.ux.form.ColorField({
	fieldLabel: 'Color',
 ...
 * @param {Object} config
 */
Ext.ux.form.ColorField = function(config){
    Ext.ux.form.ColorField.superclass.constructor.call(this, config);
	this.on('render', this.handleRender);
};

Ext.extend(Ext.ux.form.ColorField, Ext.form.TriggerField,  {
    /**
